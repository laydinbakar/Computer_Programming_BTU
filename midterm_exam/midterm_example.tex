...
%   Last Modified : 13-20-56---20-11-2022
...
\begin{enumerate}
	...
	\end{itemize}
	\item Add your group name, student ID, name and surname as a comment on the top of each scripts you write in this exam. See the example comments for shell and Python scripts below.
	\begin{itemize}
